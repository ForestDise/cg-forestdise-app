...
function Method() {
  ...
  const [methodShown, setMethodShown] = useState();
                  ...
                  <div class="px-6">
                    ...
                    {paymentMethod.map((method, index) => (
                          ...
                          >
                            ...
                            {method.cartNumber}, {method.expirationDate}
                          </div>
                      ))}
                    <div class="flex">
                      <div class="flex-none">
                        ...
                        >
                          ...
                          <form onSubmit={handleFormSubmit}>
                            <div className="grid grid-cols-5 gap-2 p-4">
                              <div className="font-semibold text-end mr-3">Card number</div>
                              <div className="...">
                                <input
                                    type="text"
                                    name="cartNumber"
                              ...
                              <div className="font-semibold text-end mr-3">Name on card</div>
                              <div className="...">
                                <input
                                    type="text"
                                    name="nameOnCard"
                              ...
                              <div className="font-semibold text-end mr-3">Expiration date</div>
                              <div className="">
                                <input
                                    type="text"
                                    name="expirationDate"
                              ...
                              <div className="col-span-2 w-full pl-8">
                                <input
                                    ...
                                    onChange={handleFormChange}
                                />
                                <span className="text-sm ml-2">Set as default payment method.</span>
                              </div>
                            </div>
