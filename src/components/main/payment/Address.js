...
import { addNewAddress, getAddress } from "../../../features/payment/paymentSlice";
                        ...
                        >
                          ...
                          <form onSubmit={handleFormSubmit}>
                            <div className="px-6 w-5/6">
                              ...
                              <div className="mb-4">
                                <div className="flex flex-col items-start">
                                  <label className="text-base font-semibold ml-4">Ward:</label>
                                  <input
                                      type="text"
                                      name="ward"
                              ...
                              <div className="mb-4">
                                <div className="flex flex-col items-start">
                                  <label className="text-base font-semibold ml-4">District:</label>
                                  <input
                                      type="text"
                                      name="district"
                              ...
                              <div className="mb-4">
                                <div className="flex flex-col items-start">
                                  <label className="text-base font-semibold ml-4">City:</label>
                                  <input
                                      type="text"
                                      name="city"
