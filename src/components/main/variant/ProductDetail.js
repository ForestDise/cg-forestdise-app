  ...
  return (
      variantDetail && <div className="font-bodyFont w-full bg-gray-100 p-1">
            ...
            <div className="w-full h-full bg-white px-4 col-span-2 flex flex-col py-10">
              ...
              <div className="font-titleFont flex items-center text-center justify-between text-sm text-yellow-500 mb-2">
                <div className="flex text-center justify-center ">
                  ...
                  <StarRating rating={variantDetail.productDTO.ratings} fontSize={15} />
                </div>
                {/* 5 star */}
              ...
              {variantDetail.variantDto.stockQuantity > 0 ?
                  <div className="font-titleFont tracking-wide text-lg text-amazon_blue size sm:text-xs  md:text-lg lg:text-xl xl:text-3xl flex mb-6 mt-4 ">
                    ...
                    <span className="text-yellow-500 text-xs ml-4 pb-0">{variantDetail.variantDto.stockQuantity} Sold</span>
                  </div>
                  :
        ...
        <div className="container mx-auto h-auto py-4 text-bodyFont flex flex-col">
          <h1 className="text-3xl font-bold pb-2">Looking for specific info?</h1>
        ...
        <div className="container mx-auto h-auto grid grid-cols-7 gap-2 text-bodyFont">
          ...
          <div className="w-full h-full col-span-2 flex flex-col py-4 border-gray-300 text-bodyFont">
            <h1 className="text-titleFont text-2xl font-bold ">Customer reviews</h1>
            ...
            <span className="text-gray-400 text-xs mb-4">16,056 global ratings</span>
            <table className="text-xs border-spacing-2 border-collapse">
              <tbody className="text-amazon_ember">
              <tr className="">
                <td className="w-2/12	"><a className="decoration-0   text-left justify-between"> 5 star</a></td>
                <td className="w-8/12	">
                  <a href="#" className="" title="5 star represent ...% of rating">
              ...
              <tr className="">
                <td><a className="decoration-0 text-left"> 4 star</a></td>
                <td className="w-8/12	">
                  <a href="#" className="" title="5 star represent ...% of rating">
                    <div className="overflow-hidden hover:shadow-testShadow bg-gray-200 h-5 rounded-sm">
              ...
              <tr className="mb-4">
                <td><a className="decoration-0 text-left"> 3 star</a></td>
                <td className="w-8/12	">
                  <a href="#" className="" title="5 star represent ...% of rating">
                    <div className="overflow-hidden hover:shadow-testShadow bg-gray-200 h-5 rounded-sm">
                      <div className="w-1/6 h-full rounded-sm bg-yellow-400 transition-width ease	duration-200" ></div>
              ...
              <tr className="mb-4">
                <td><a className="decoration-0 text-left"> 2 star</a></td>
                <td className="w-8/12	">
                  <a href="#" className="" title="5 star represent ...% of rating">
                    <div className="overflow-hidden hover:shadow-testShadow bg-gray-200 h-5 rounded-sm">
                      <div className="w-1/6 h-full rounded-sm bg-yellow-400 transition-width ease	duration-200" ></div>
              ...
              <tr className="mt-4">
                <td><a className="decoration-0   text-left"> 1 star</a></td>
                <td className="w-8/12	">
                  <a href="#" className="" title="5 star represent ...% of rating">
                    <div className="overflow-hidden hover:shadow-testShadow bg-gray-200 h-5 rounded-sm">
            ...
            <div className="flex flex-row h-full item-center justify-start mt-4 mb-4">
              ...
              >How customer reviews and ratings work?</span>

            </div>
            {showRecommend && (
                <div className="flex flex-col w-10/12 text-start pl-3 font-titleFont text-sm pb-4">
                  <span>Customer Reviews, including Product Star Ratings help customers to learn more about the product and decide whether it is the right product for them.</span>
                  <br></br>
                  <span>To calculate the overall star rating and percentage breakdown by star, we don’t use a simple average. Instead, our system considers things like how recent a review is and if the reviewer bought the item on Amazon. It also analyzed reviews to verify trustworthiness.</span>
                </div>
            )}
            {/* Star Index end */}
            <hr></hr>
            ...
            <button className=" p-1 bg-gray-300 rounded-md text-bodyFont text-xs mb-4">Write a customer review</button>
            <hr></hr>
          ...
          <div className="w-full h-full col-span-5 flex flex-col py-4 border-gray-300 text-titleFont  ">
            <div className="flex flex-row text-center justify-between ">
              ...
              <div>
                <a className="hover:underline text-amazon_ember">See all photo</a><ArrowRightIcon />
              </div>
            </div>
            ...
            <h1 className="text-2xl font-bold mb-6">Top reviews from the United States</h1>

            <div className="m-4">
              <div className="flex mb-2">
                <img src="https://scontent.fsgn5-10.fna.fbcdn.net/v/t1.6435-9/116429521_1655876004585921_941667011043408186_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=84a396&_nc_ohc=jX_SP-XeWGUAX8gd9Dl&_nc_ht=scontent.fsgn5-10.fna&oh=00_AfB8K54ttI7F3njd8xLWtnInOErSx2FkaIhUXEuNjobBRw&oe=654A001A" className="rounded-full w-5 h-5" />
              ...
              <div className="flex">
                ...
                <a className="text-bodyFont text-sm ml-4 font-medium hover:underline hover:text-amber-600"> I wish that I had found these before I spent 1000's on doctors and Physical therapy</a>
              </div>
