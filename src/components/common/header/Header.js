...
function Header() {
    ...
    return (
        <div>
            ...
            {showUserOption && (
                <div
                    className="fixed bg-white bg-opacity-0 top-[49px] left-[998px] right-[0px] z-50 w-[28%] p-3 overflow-hidden h-[37%]">
                    <div
                        onMouseLeave={() => {
                            setShowUserOption(false);
                            changeScroll();
                    ...
                    >
                        <div
                            className="font-bodyFont relative w-[60%] h-[40%] left-[85px] -top-[10px] bg-white rounded-lg shadow dark:bg-gray-700">
                            <div
                                className="w-[100px mx-auto text-center flex flex-col gap-1 justify-between p-4 border-b rounded-t dark:border-gray-600">
                                {userInfo ? (
                                    <Fragment>
                                        <button
