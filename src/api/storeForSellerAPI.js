...
export const findShop = async (shopId) => {
    let result = null;
    try {
        result = await axios.get(`${STORE_FOR_SELLER_MANAGEMENT_API}/${shopId}`);
    } catch (e) {
...
export const createShop = async ({shop,sellerId}) => {
    let result = null;
    try {
        result = await axios.post(`${STORE_FOR_SELLER_MANAGEMENT_API}/create/${sellerId}`, shop);
    } catch (e) {
...
export const updateShop = async (shop) => {
    let result = null;
    try {
        result = await axios.put(`${STORE_FOR_SELLER_MANAGEMENT_API}/${shop.id}`, shop);
    } catch (e) {
